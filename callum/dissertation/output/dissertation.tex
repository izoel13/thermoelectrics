...
% Unicode support
\usepackage{xunicode}
% Enables OpenType fonts and clever font typesetting
%\usepackage{fontspec}
% Body text super-sub scripts, \textsubscript \textsuperscript (needs fontspec)
...
% Define new command for sans-serif x, for times
