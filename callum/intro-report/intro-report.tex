...
\title{wvxx: Ultrasound Experiments}
\author{\IEEEauthorblockN{Callum Vincent}\\
\IEEEauthorblockA{cv235@exeter.ac.uk\\25 March 2013}
}
%\date{10 February 2013}	not working???

% Single column abstract. See:
% Q: How do I get a single column abstract and/or index terms section in a two
% column document?
% http://www.michaelshell.org/tex/ieeetran/
%
%
% Do:
% diffraction in abstract
% discussion
% flesh out introduction
% check/organise all the info
% check conclusion
%
%
\IEEEaftertitletext{\vspace{-1\baselineskip}\noindent
\begin{abstract}
Our experiments were designed to demonstrate and validate the theories behind the wave properties of ultrasound. Small differences in the frequency ($\Delta f$) of closely mounted ultrasound transducers produces beats, a periodically varying amplitude envelope with frequency equal to $\Delta f$, which we verified to 1.8\% agreement. Diffraction of ultrasound should follow The speed of sound in air is proportional to air pressure and density. Using an echolocation method at RTP, we found the speed of ultrasound to be $344.2 \pm 0.69 ms^{-1}$, 0.31\% from accepted values. When wave sources \& observers have velocities relative to each other, ($\Delta v$) a change in frequency proportional to $\Delta v$ is observed, known as Doppler shift. Using an infrared motion capture suite, rail push trolley and the beats phenomena we verified Doppler theory to 4.3\% agreement. We conclude that wave theory is a good model for ultrasound in air.
\end{abstract}
